...
public class ResultDecryptMode {
  ...
  public ResultDecryptMode(String filePath, String keyPath, String resultPath, String result) {
    ...
    btnEncryptNow.addActionListener(new ActionListener( ) {
        public void actionPerformed(ActionEvent event) {
			...
			try {
				...
				frame.setVisible(false);
				new ResultEncryptMode(resultPath, keyPath, anotherResult, anotherSolver.encryptedText);
			} catch (Exception e) {
				e.printStackTrace();
			}
        }
